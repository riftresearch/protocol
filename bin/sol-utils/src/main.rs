...
async fn generate_fake_block_mmr_proof(height: u32, debug: bool) {
    ...
    let block_leaf = sol_bindings::BlockLeaf {
...
async fn generate_fake_block_with_confirmations_mmr_proof(
    ...
    let tip_block_leaf = sol_bindings::BlockLeaf {
    ...
    let full_proof = sol_bindings::nonpublic::ReleaseMMRProof {
        proof: sol_mmr_proof,
...
async fn get_deployment_params(checkpoint_file: &str, debug: bool) {
    ...
    let tip_block_leaf: sol_bindings::BlockLeaf = tip_block_leaf.into();
